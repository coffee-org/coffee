...
static CLICMDARGDEF farg[] = {
    ...
    {CLIARG_LONG, ".NBlambda", "", "10", CLIARG_VISIBLE_DEFAULT, (void **)&NBlambdaval, NULL},
    {CLIARG_LONG, ".PTstep", "EvalPts step", "2", CLIARG_VISIBLE_DEFAULT, (void **)&PTstepval, NULL}};

static CLICMDDATA CLIcmddata = {"fpmresprs", "resample FPM resp matrix", CLICMD_FIELDS_DEFAULTS};

// detailed help
static errno_t help_function() { return RETURN_SUCCESS; }

// compress FPMresp to smaller number of lambda and points
errno_t PIAACMC_FPMresp_resample(const char *__restrict__ FPMresp_in_name, const char *__restrict__ FPMresp_out_name,
                                 long NBlambda, long PTstep, imageID *outID)
{
    DEBUG_TRACE_FSTART();
    ...
    FUNC_CHECK_RETURN(create_3Dimage_ID_double(FPMresp_out_name, xsize1, ysize, zsize1, &IDout));
...
static errno_t compute_function()
{
    ...
    PIAACMC_FPMresp_resample(FPMrespinimname, FPMrespoutimname, *NBlambdaval, *PTstepval, NULL);
