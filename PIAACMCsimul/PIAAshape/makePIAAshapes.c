...
errno_t makePIAAshapes()
{
    ...
    {   // if using PIAA optics
        ...
        DEBUG_TRACEPOINT_LOG("piaacmcparams.MAKE_PIAA0shape %d", piaacmcparams.MAKE_PIAA0shape);
        ...
        {   // if PIAA shapes should be computed
            ...
            if(piaacmcparams.PIAACMC_save == 1)
            {
                ...
                WRITE_FULLFILENAME(fname, "%s/piaa0Fz.fits", piaacmcparams.piaacmcconfdir);
